...
CREATE OR REPLACE VIEW omop_cdm.person AS
  SELECT * FROM omop_modified.person;

CREATE SEQUENCE IF NOT EXISTS omop_modified.person_id_seq;
ALTER TABLE omop_modified.person ALTER COLUMN person_id SET DEFAULT nextval('omop_modified.person_id_seq');
...
CREATE TABLE custom.user_device (
    ...
    user_id             INTEGER NOT NULL REFERENCES custom.person_info(person_id) ON DELETE CASCADE,
...
--  OMOP: measurement
CREATE TABLE omop_modified.measurement (
...
CREATE OR REPLACE VIEW omop_cdm.measurement AS
...
--  OMOP: observation 
    ...
    observation_id                      SERIAL NOT NULL,
		...
		observation_datetime                TIMESTAMPTZ NULL,
...
ALTER TABLE omop_modified.PERSON ADD CONSTRAINT fpk_PERSON_gender_concept_id FOREIGN KEY (gender_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.PERSON ADD CONSTRAINT fpk_PERSON_race_concept_id FOREIGN KEY (race_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.PERSON ADD CONSTRAINT fpk_PERSON_ethnicity_concept_id FOREIGN KEY (ethnicity_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.PERSON ADD CONSTRAINT fpk_PERSON_location_id FOREIGN KEY (location_id) REFERENCES omop_cdm.LOCATION (LOCATION_ID);
ALTER TABLE omop_modified.PERSON ADD CONSTRAINT fpk_PERSON_provider_id FOREIGN KEY (provider_id) REFERENCES omop_cdm.PROVIDER (PROVIDER_ID);
ALTER TABLE omop_modified.PERSON ADD CONSTRAINT fpk_PERSON_care_site_id FOREIGN KEY (care_site_id) REFERENCES omop_cdm.CARE_SITE (CARE_SITE_ID);
ALTER TABLE omop_modified.PERSON ADD CONSTRAINT fpk_PERSON_gender_source_concept_id FOREIGN KEY (gender_source_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.PERSON ADD CONSTRAINT fpk_PERSON_race_source_concept_id FOREIGN KEY (race_source_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.PERSON ADD CONSTRAINT fpk_PERSON_ethnicity_source_concept_id FOREIGN KEY (ethnicity_source_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);

ALTER TABLE omop_cdm.OBSERVATION_PERIOD ADD CONSTRAINT fpk_OBSERVATION_PERIOD_person_id FOREIGN KEY (person_id) REFERENCES omop_modified.PERSON (PERSON_ID);
...
ALTER TABLE omop_cdm.VISIT_OCCURRENCE ADD CONSTRAINT fpk_VISIT_OCCURRENCE_person_id FOREIGN KEY (person_id) REFERENCES omop_modified.PERSON (PERSON_ID);
...
ALTER TABLE omop_cdm.VISIT_DETAIL ADD CONSTRAINT fpk_VISIT_DETAIL_person_id FOREIGN KEY (person_id) REFERENCES omop_modified.PERSON (PERSON_ID);
...
ALTER TABLE omop_cdm.CONDITION_OCCURRENCE ADD CONSTRAINT fpk_CONDITION_OCCURRENCE_person_id FOREIGN KEY (person_id) REFERENCES omop_modified.PERSON (PERSON_ID);
...
ALTER TABLE omop_cdm.DRUG_EXPOSURE ADD CONSTRAINT fpk_DRUG_EXPOSURE_person_id FOREIGN KEY (person_id) REFERENCES omop_modified.PERSON (PERSON_ID);
...
ALTER TABLE omop_cdm.PROCEDURE_OCCURRENCE ADD CONSTRAINT fpk_PROCEDURE_OCCURRENCE_person_id FOREIGN KEY (person_id) REFERENCES omop_modified.PERSON (PERSON_ID);
...
ALTER TABLE omop_cdm.DEVICE_EXPOSURE ADD CONSTRAINT fpk_DEVICE_EXPOSURE_person_id FOREIGN KEY (person_id) REFERENCES omop_modified.PERSON (PERSON_ID);
...
ALTER TABLE omop_modified.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_person_id FOREIGN KEY (person_id) REFERENCES omop_modified.PERSON (PERSON_ID);
ALTER TABLE omop_modified.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_measurement_concept_id FOREIGN KEY (measurement_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_measurement_type_concept_id FOREIGN KEY (measurement_type_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_operator_concept_id FOREIGN KEY (operator_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_value_as_concept_id FOREIGN KEY (value_as_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_unit_concept_id FOREIGN KEY (unit_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_provider_id FOREIGN KEY (provider_id) REFERENCES omop_cdm.PROVIDER (PROVIDER_ID);
ALTER TABLE omop_modified.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_visit_occurrence_id FOREIGN KEY (visit_occurrence_id) REFERENCES omop_cdm.VISIT_OCCURRENCE (VISIT_OCCURRENCE_ID);
ALTER TABLE omop_modified.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_visit_detail_id FOREIGN KEY (visit_detail_id) REFERENCES omop_cdm.VISIT_DETAIL (VISIT_DETAIL_ID);
ALTER TABLE omop_modified.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_measurement_source_concept_id FOREIGN KEY (measurement_source_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_unit_source_concept_id FOREIGN KEY (unit_source_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.MEASUREMENT ADD CONSTRAINT fpk_MEASUREMENT_meas_event_field_concept_id FOREIGN KEY (meas_event_field_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);

ALTER TABLE omop_modified.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_person_id FOREIGN KEY (person_id) REFERENCES omop_modified.PERSON (PERSON_ID);
ALTER TABLE omop_modified.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_observation_concept_id FOREIGN KEY (observation_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_observation_type_concept_id FOREIGN KEY (observation_type_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_value_as_concept_id FOREIGN KEY (value_as_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_qualifier_concept_id FOREIGN KEY (qualifier_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);
ALTER TABLE omop_modified.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_unit_concept_id FOREIGN KEY (unit_concept_id) REFERENCES omop_cdm.CONCEPT (CONCEPT_ID);

ALTER TABLE omop_modified.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_provider_id FOREIGN KEY (provider_id) REFERENCES omop_cdm.PROVIDER (PROVIDER_ID);
ALTER TABLE omop_modified.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_visit_occurrence_id FOREIGN KEY (visit_occurrence_id) REFERENCES omop_cdm.VISIT_OCCURRENCE (VISIT_OCCURRENCE_ID);
ALTER TABLE omop_modified.OBSERVATION ADD CONSTRAINT fpk_OBSERVATION_visit_detail_id FOREIGN KEY (visit_detail_id) REFERENCES omop_cdm.VISIT_DETAIL (VISIT_DETAIL_ID);
...
ALTER TABLE omop_cdm.CONDITION_ERA ADD CONSTRAINT fpk_CONDITION_ERA_person_id FOREIGN KEY (person_id) REFERENCES omop_modified.PERSON (PERSON_ID);
...
ALTER TABLE omop_cdm.EPISODE ADD CONSTRAINT fpk_EPISODE_person_id FOREIGN KEY (person_id) REFERENCES omop_modified.PERSON (PERSON_ID);
